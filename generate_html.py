    ...
    <main>
        <div class="container">
                ...
                <div class="grid-2 mt-4">
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-desc">
                                <p class="mb-2">Wholesome enough for toast, hearty enough for sandwiches, and delicious enough to enjoy on its own.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-desc">
                                <ul style="list-style: disc; margin-left: 1.5rem; color: var(--color-text); font-size: 0.95rem; line-height: 1.5;">
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-desc">
                                <ul style="list-style: disc; margin-left: 1.5rem; color: var(--color-text); font-size: 0.95rem; line-height: 1.5;">
                                    <li style="margin-bottom: 4px;"><strong>Seeded Whole Wheat:</strong> Packed with nutritious seeds for a hearty crunch (Sandwich loaf only).</li>
                                    <li style="margin-bottom: 4px;"><strong>Apple Pie:</strong> A sweet sourdough swirl reminiscent of warm, classic apple pie.</li>
                                    <li style="margin-bottom: 4px;"><strong>Cinnamon, Raisin, & Brown Sugar:</strong> Made with plump raisins, dark brown sugar, and rich cinnamon.</li>
                                    <li style="margin-bottom: 4px;"><strong>Pepperoni Pizza:</strong> A savory hit loaded with classic pepperoni pizza flavors.</li>
                                    <li style="margin-bottom: 4px;"><strong>Chocolate & Chocolate Chip:</strong> A decadent double-chocolate treat.</li>
                                    <li style="margin-bottom: 4px;"><strong>Chocolate Covered Cherry:</strong> Tart cherries perfectly balanced with rich chocolate.</li>
                                    <li><strong>Pumpkin Spice:</strong> Warm fall spices swirled in the perfect loaf.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                         ...
                         <div class="card-content">
                            ...
                            <div class="card-desc">
                                <p class="mb-2">Can't decide? Try a flight of four mini sandwich loaves! Choose your mix:</p>
                                <ul style="list-style: disc; margin-left: 1.5rem; color: var(--color-text); font-size: 0.95rem; line-height: 1.6;">
                ...
                <div class="grid-3 mt-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-desc">
                                ...
                                <ul style="margin-bottom: 0.5rem; list-style: none; font-size: 0.9rem; color: var(--color-text);">
                                    <li>Plain ($12) | Garlic & Rosemary ($13)</li>
                                    <li>Apple Pie / Pepperoni Pizza / Garden Veggie ($17)</li>
                                    <li>Specialty ($18)</li>
                                </ul>
                                <p style="font-size: 0.95rem; margin-top: 0.5rem;"><strong>9x13 Pan:</strong></p>
                                <ul style="list-style: none; font-size: 0.9rem; color: var(--color-text);">
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-desc">
                                <p style="margin-bottom: 0.5rem;">Decadent bakery cookies:</p>
                                <ul style="list-style: none; font-size: 0.95rem; line-height: 1.8; color: var(--color-text);">
            ...
            <div class="mb-4" style="margin-top: 4rem;">
                ...
                <div class="grid-3 mt-4">
                    <div class="card">
                        <img src="assets/images/PXL_20250912_213210076.webp" alt="Oatmeal Cream Pies" class="card-img" loading="lazy">
                        <div class="card-content">
                            <h3 class="card-title">Oatmeal Cream Pies</h3>
                            <div class="card-desc">
                                <p>Sourdough Oatmeal Cream Pies made with a delightful sweet filling.</p>
                                <p><strong>$20</strong> per ½ dozen<br><strong>$35</strong> per dozen</p>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div class="card-content">
                            <h3 class="card-title">Fresh Muffins</h3>
                            <div class="card-desc">
                                <p><strong>$2 each</strong> (minimum 6 of the same flavor).<br><br>Available in Blueberry, Strawberry, Banana Nut, and Chocolate Chip.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-desc">
                                <p style="margin-bottom: 0.5rem;"><strong>Sandwich Buns:</strong> $7 per pack of 4.</p>
                                <p><strong>Dinner Rolls:</strong> $10 per dozen.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <img src="assets/images/sweet_savory_pecans.png" alt="Sweet & Savory Pecans" class="card-img" loading="lazy">
                        <div class="card-content">
                            <h3 class="card-title">Glazed Pecans</h3>
                            <div class="card-desc">
                                <p><strong>Sweet & Savory Pecans</strong> roasted and perfectly glazed.</p>
                                <p><strong>$20</strong> per pound</p>
                            </div>
                        </div>
                    </div>
                </div>
